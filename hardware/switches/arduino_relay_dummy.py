...
"""
This file contains the hardware dummy to emulate control the simple arduino UNO relay
...
class ArduinoRelayDummy(Base, SwitchInterface):
    """
    ...
    _state = 'positive'
    _switch_name = "Arduino UNO relay DUMMY"

    _switch_states = ConfigOption(name='switch_states', default=['positive', 'negative'], missing='nothing')
    _hardware_name = ConfigOption(name='name', default='arduino uno relay DUMMY', missing='nothing')
