...
"""
This file containing dummy hardware module for lock-in emulation.
...
class LockInDummy(Base, SimpleDataInterface):
    """
    Dummy hardware class for lock-in control.
    """
    ...
    def on_activate(self):
        ...
        Not sure if all these are important
        """
